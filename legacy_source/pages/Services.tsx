              ...
              >
                <div className="relative h-[600px] mb-8 overflow-hidden rounded-[3px] shadow-lg">
                  <img 
                    src={service.image} 
                    alt={service.title} 
                    className="w-full h-full object-cover grayscale brightness-90 group-hover:brightness-100 group-hover:grayscale-0 transition-all duration-[1.2s] ease-luxury group-hover:scale-105" 
                  />
