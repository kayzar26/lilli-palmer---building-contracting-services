          ...
          {BLOGS.map((blog, idx) => (
            ...
            >
              <Link to={`/blog/${blog.id}`} className="block">
                <div className="aspect-[4/3] overflow-hidden rounded-sm mb-6 shadow-md">
                  <img 
                    src={blog.image} 
                    alt={blog.title} 
                    className="w-full h-full object-cover grayscale group-hover:grayscale-0 group-hover:scale-105 transition-all duration-[1s] ease-luxury"
                  />
                </div>
