...
const BlogDetail: React.FC = () => {
  ...
  const recentPosts = BLOGS.filter(b => b.id !== id).slice(0, 2);
  ...
  return (
    <div className="pt-32 pb-20 bg-[#EBEBEB]">
      <div className="container mx-auto px-6">
        ...
        >
          <Link to="/blog" className="inline-flex items-center gap-2 text-xs font-bold tracking-widest text-gray-400 hover:text-[#BBA899] transition-colors mb-12 uppercase">
