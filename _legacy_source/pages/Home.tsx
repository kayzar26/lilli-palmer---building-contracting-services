      ...
      <section className="bg-[#EBEBEB] py-40 px-6 relative">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-32 items-center">
          <motion.div 
            ...
            whileInView="visible"
            viewport={{ once: true }}
            className="relative h-[800px] overflow-hidden rounded-[2px] shadow-2xl group"
          >
            <img 
              src="https://images.unsplash.com/photo-1517581177682-a085bb7ffb15?auto=format&fit=crop&q=80&w=1000" 
              alt="Luxury Construction" 
              className="w-full h-full object-cover grayscale brightness-90 group-hover:brightness-100 group-hover:grayscale-0 transition-all duration-1000 ease-luxury"
            />
          </motion.div>
          <motion.div 
            variants={fadeUpVariants}
          ...
          >
            ...
            <div className="pt-8">
              <Link to="/about" className="group inline-flex items-center gap-4 text-h1-custom text-black pb-2 border-b-2 border-black hover:text-[#BBA899] hover:border-[#BBA899] transition-all ease-luxury">
                EXPLORE OUR LEGACY
      ...
      <section className="bg-white py-40 overflow-hidden">
        <div className="container mx-auto px-6 mb-20">
          ...
          >
            ...
            <Link to="/services" className="text-h1-custom text-black hover:text-[#BBA899] transition-colors pb-2 border-b-2 border-black uppercase tracking-widest">
              VIEW SERVICES
            </Link>
          </motion.div>
        </div>
            ...
            >
              <div className="relative aspect-[4/5] overflow-hidden mb-8 rounded-[3px] shadow-lg">
                <img 
                  src={project.image} 
                  alt={project.title} 
                  className="w-full h-full object-cover grayscale brightness-90 transition-transform duration-[1.5s] ease-luxury group-hover:scale-110 group-hover:grayscale-0 group-hover:brightness-100"
                />
