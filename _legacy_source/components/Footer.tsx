        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mb-20">
          ...
          <div className="flex flex-col md:items-end justify-between">
            <nav className="flex flex-col md:items-end gap-4 text-4xl md:text-6xl font-light">
              <Link to="/" className="hover:text-[#BBA899] transition-colors">HOME</Link>
              <Link to="/services" className="hover:text-[#BBA899] transition-colors">SERVICES</Link>
              <Link to="/about" className="hover:text-[#BBA899] transition-colors">ABOUT</Link>
              <Link to="/contact" className="hover:text-[#BBA899] transition-colors">CONTACT</Link>
            </nav>
